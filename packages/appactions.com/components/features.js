                    ...
                    <div className="lg:w-1/2 grid sm:grid-cols-2 gap-10 md:gap-16 mt-20 lg:mt-0 lg:ml-40 flex-shrink-0">
                        ...
                        <div>
                            <div className="gotham font-medium">
                                ...
                                <p className="text-lg text-gray-700 opacity-60 pt-4">
                                    Protect your API from traffic spikes and downtime. Allow your users to rely on you,
                                    always.
                                </p>
                            </div>
                        </div>
                        <div>
                            <div className="gotham font-medium">
                                ...
                                <p className="text-lg text-gray-700 opacity-60 pt-4">
                                    Reduce your origin load by up to 95%. Handle any traffic spike, avoid downtime and
                                    save costs.
                                </p>
                            </div>
                        </div>
                        <div>
                            <div className="gotham font-medium">
                                ...
                                <p className="text-lg text-gray-700 opacity-60 pt-4">
                                    Resolve stability issues with auto retries and stale-while-revalidate. Steady wins
                                    the race.
                                </p>
                            </div>
                        </div>
                    ...
                    <div className="lg:w-1/2 grid sm:grid-cols-2 gap-10 md:gap-16 mt-20 lg:mt-0 lg:ml-40 flex-shrink-0">
                        ...
                        <div>
                            <div className="gotham font-medium">
                                ...
                                <p className="text-lg text-gray-700 opacity-60 pt-4">
                                    Edit your schema based on usage data and insights. Rely on facts and be confident in
                                    your changes.
                                </p>
                            </div>
                        </div>
                        <div>
                            <div className="gotham font-medium">
                                ...
                                <p className="text-lg text-gray-700 opacity-60 pt-4">
                                    See which country, page and user sent which request. Get granular insights and
                    ...
                    <div className="lg:w-1/2 grid sm:grid-cols-2 gap-10 md:gap-16 mt-20 lg:mt-0 lg:ml-40 flex-shrink-0">
                        <div>
                            <div className="gotham font-medium">
                                ...
                                <p className="text-lg text-gray-700 opacity-60 pt-4">
                                    Track all HTTP &amp; GraphQL errors. Understand when and where users run into issues
                                    and fix them.
                                </p>
                            </div>
                        </div>
                        <div>
                            <div className="gotham font-medium">
                                ...
                                <p className="text-lg text-gray-700 opacity-60 pt-4">
                                    Check the origin response times for each query and mutation. Know where to optimize
                                    your API.
                                </p>
                            </div>
                        </div>
                        <div>
                            <div className="gotham font-medium">
                                ...
                                <p className="text-lg text-gray-700 opacity-60 pt-4">
                                    Learn about performance drops and errors the second your users do and resolve them
                                    quickly.
                                </p>
                            </div>
                        </div>
                        <div>
                            <div className="gotham font-medium">
                                ...
                                <p className="text-lg text-gray-700 opacity-60 pt-4">
                                    Define who gets notified about what on Email, Slack or Pagerduty. Always contact the
                                    right person.
                                </p>
                            </div>
                        </div>
